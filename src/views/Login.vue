<template>
  <div class="authentication-wrapper authentication-3">
    <div class="authentication-inner">
      <b-col
        lg="8"
        class="d-none d-lg-flex align-items-center ui-bg-cover ui-bg-overlay-container p-5 login-bg"
      >
        ...
        <b-col sm="7" md="5" lg="12" class="d-flex px-0 px-xl-4 mx-auto">
          <div class="w-100">
            ...
            <form class="my-5" @submit="login">
              ...
              <b-form-group>
                ...
                >
                  ...
                  <b-link
                    to="/forgot-password"
                    class="d-block small text-landing-primary"
              ...
              >
                <b-check v-model="credentials.isPersistent" class="m-0"
                  >Remember me</b-check
                >
            ...
            <div class="text-center text-muted">
              ...
              <b-link to="/register" class="text-landing-primary"
                >Sign Up</b-link
              >
            </div>
          </div>
  ...
  methods: {
    ...
    validateForm() {
      if (
        ...
        this.validationErrors.push("email giriniz.");
      ...
      if (
        ...
        this.validationErrors.push("parola giriniz.");
